...
namespace EdiTools.Tests
{
    ...
    public class ReadAndWriteEdiX12
    {
        ...
        public void WriteFile()
        {
            ...
            var orgGS = new Organization(new OrganizationName("GOODSHIP"), new AddressInformation("699 Lively Blvd"), new AddressInformation(""), new CityName("Elk Grove Village"), new StateOrProvince("IL"), new PostalCode("60007"), new CountryCode("USA"));
            var orgDE = new Organization(new OrganizationName("DEXTER AXLE"), new AddressInformation("902 S. DIVISION ST"), new AddressInformation(""), new CityName("BRISTOL"), new StateOrProvince("IN"), new PostalCode("46507"), new CountryCode("USA"));
            var orgABC = new Organization(new OrganizationName("ABC COMPANY"), new AddressInformation("2686 COMMERCE ROAD"), new AddressInformation(""), new CityName("MacClenny"), new StateOrProvince("FL"), new PostalCode("32063"), new CountryCode("USA"));
            transactionSet.Add(new EdiSegmentN1(EntityIdentifierCode.SE, orgGS, IdentificationCodeQualifier.GoodShip, new IdentificationCode(Info.GoodShipId)));
            transactionSet.Add(new EdiSegmentN1(EntityIdentifierCode.BY, orgDE, IdentificationCodeQualifier.DexterAxel, new IdentificationCode(Info.DexterAxelId)));
        ...
        => new GoodShipInvoiceData
                        {
                            ...
                            OrgSE = new Organization(new OrganizationName("GOODSHIP"), new AddressInformation("699 Lively Blvd"), new AddressInformation(""), new CityName("Elk Grove Village"), new StateOrProvince("IL"), new PostalCode("60007"), new CountryCode("USA")),
                            OrgBY = new Organization(new OrganizationName("DEXTER AXLE"), new AddressInformation("902 S. DIVISION ST"), new AddressInformation(""), new CityName("BRISTOL"), new StateOrProvince("IN"), new PostalCode("46507"), new CountryCode("USA")),
                            OrgSF = new Organization(new OrganizationName("DEXTER AXLE"), new AddressInformation("902 S. DIVISION ST"), new AddressInformation(""), new CityName("BRISTOL"), new StateOrProvince("IN"), new PostalCode("46507"), new CountryCode("USA")),
                            OrgST = new Organization(new OrganizationName("ABC COMPANY"), new AddressInformation("2686 COMMERCE ROAD"), new AddressInformation(""), new CityName("MacClenny"), new StateOrProvince("FL"), new PostalCode("32063"), new CountryCode("USA")),
                            Invoices = new List<GoodShipInvoiceData.InvoiceElements>()
                                        {
